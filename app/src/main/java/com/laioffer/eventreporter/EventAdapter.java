...
public class EventAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position < 2) {
            eventImage.setImageDrawable(context.getDrawable(R.drawable.ic_launcher_background));
        } else if (position < 4) {
            eventImage.setImageDrawable(context.getDrawable(R.drawable.ic_launcher_foreground));
        }
